  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 hero-kenburns">
        ...
        >
          ...
          <g>
            ...
            <circle cx="1000" cy="450" r="34" fill="#0F1E33" />
            <circle
              cx="1000"
              cy="450"
              r="34"
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-10">
        <p className="eyebrow text-xs text-blue-bright">
